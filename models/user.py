...
class CadastrarSubacao(db.Model):
    ...
    meta_subacao = db.Column(db.Numeric(19, 2))
    ...
    regiao_memoria = db.Column(db.String(255))
    natureza = db.Column(db.String(13))
    fonte = db.Column(db.String(255))
    idu = db.Column(db.String(255))
    descricao = db.Column(db.String(2000))
    unidade_etapa = db.Column(db.String(255))
    quantidade = db.Column(db.Numeric(19, 2))
    valor_unitario = db.Column(db.Numeric(19, 2))
    valor_total = db.Column(db.Numeric(19, 2))

...
class Plan21Nger(db.Model):
    ...
    responsavel_etapa = db.Column(db.String(255))
...
class CadastrarSubacao(db.Model):
    __tablename__ = "cadastrar_subacao"
    ...
    unid_gestora = db.Column(db.String(255))
    unidade_setorial_planejamento = db.Column(db.String(255))
    produto_subacao = db.Column(db.Text)
    unidade_medida = db.Column(db.String(255))
    regiao_subacao = db.Column(db.Text)
    codigo = db.Column(db.String(100))
    municipios_entrega = db.Column(db.Text)
    # Lista/concat de metas por municipio (ex: "10*20*30")
    meta_subacao = db.Column(db.Text)
    detalhamento_produto = db.Column(db.Text)
    etapa = db.Column(db.Text)
    responsavel_etapa = db.Column(db.String(255))
    cpf_responsavel_etapa = db.Column(db.String(14))
    justificativa = db.Column(db.Text)
    responsavel_nger = db.Column(db.String(255))
    tipo_solicitacao = db.Column(db.String(20), nullable=False, server_default="cadastrar")
    tipo_edicao = db.Column(db.String(30))
    ativo = db.Column(db.Boolean, nullable=False, default=True, server_default=db.text("1"))
    plan21_nger_id = db.Column(db.BigInteger)
...
class AlterarMeta(db.Model):
    ...
    responsavel_acao = db.Column(db.String(255))
    produto_acao = db.Column(db.Text)
    unid_medida_produto = db.Column(db.String(255))
    regiao_produto = db.Column(db.Text)
    meta_produto = db.Column(db.Numeric(19, 2))
    meta_credito = db.Column(db.Numeric(19, 2))
    meta_anulada = db.Column(db.Numeric(19, 2))
    meta_atual = db.Column(db.Numeric(19, 2))
    justificativa = db.Column(db.Text)
    plan21_nger_id = db.Column(db.BigInteger)
    plan21_nger_ids = db.Column(db.Text)
    usuario_id = db.Column(db.BigInteger)
